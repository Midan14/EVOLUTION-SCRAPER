...
from src.ev_calculator import calculate_player_ev, calculate_banker_ev, format_ev
...
class BankrollManager:
    ...
    def get_signal(
        ...
        if prediction == "Player":
            ...
            effective_payout = (1 + avg_multiplier) * (1 - self.lightning_fee) * (1 - self.banker_commission)
        else:
